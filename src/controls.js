...
function handleDirectionChange(event, currentDirection) {
  if (event.key === "ArrowLeft" && currentDirection !== "RIGHT" || event.key === "a" && currentDirection !== "RIGHT") {
    return "LEFT";
  } else if (event.key === "ArrowUp" && currentDirection !== "DOWN" || event.key === "w" && currentDirection !== "DOWN") {
    return "UP";
  } else if (event.key === "ArrowRight" && currentDirection !== "LEFT" || event.key === "d" && currentDirection !== "LEFT") {
    return "RIGHT";
  } else if (event.key === "ArrowDown" && currentDirection !== "UP"  || event.key === "s" && currentDirection !== "UP") {
    return "DOWN";
  }
